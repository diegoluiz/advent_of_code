...
fn part_01(input: (&Vec<char>, &Vec<Vec<char>>)) -> String {
    process(2, input)
}
fn part_02(input: (&Vec<char>, &Vec<Vec<char>>)) -> String {
    process(50, input)
}
...
fn main() {
    ...
    let part_01_output = part_01((&iea, &image));
    println!(
    ...
    let part_02_output = part_02((&iea, &image));
    println!(
